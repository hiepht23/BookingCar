package com.vnpt.media.bookingcar.customview.linearlistview;
...
public class IcsLinearLayout extends LinearLayout {
	private static int[] rStyleableLinearLayout = new int[] {
	/* 0 */android.R.attr.divider,
	/* 1 */android.R.attr.measureWithLargestChild,
	/* 2 */android.R.attr.showDividers,
	/* 3 */android.R.attr.dividerPadding, };
	private static int linearLayoutDivider = 0;
	private static int linearLayoutMeasureWithLargestChild = 1;
	private static int linearLayoutShowDividers = 2;
	private static int linearLayoutDividerPadding = 3;
	...
	public IcsLinearLayout(Context context, AttributeSet attrs) {
		...
		TypedArray array = context.obtainStyledAttributes(attrs, /*
																 ...
																 * .R.styleable.
																 */
				rStyleableLinearLayout);

		setDividerDrawable(array
				.getDrawable(/* com.android.internal.R.styleable. */linearLayoutDivider));
		mShowDividers = array
				.getInt(/* com.android.internal.R.styleable. */linearLayoutShowDividers,
						SHOW_DIVIDER_NONE);
		mDividerPadding = array.getDimensionPixelSize(
				/*
				 * com.android.internal.R.styleable .
				 */linearLayoutDividerPadding, 0);
		mUseLargestChild = array
				.getBoolean(
						/* com.android.internal.R.styleable. */linearLayoutMeasureWithLargestChild,
						false);
	...
	void drawHorizontalDivider(Canvas canvas, int top) {
		if (mClipDivider && !IS_HONEYCOMB) {
			canvas.save();
			canvas.clipRect(getPaddingLeft() + mDividerPadding, top, getWidth()
					- getPaddingRight() - mDividerPadding, top + mDividerHeight);
			mDivider.draw(canvas);
			canvas.restore();
		} else {
			mDivider.setBounds(getPaddingLeft() + mDividerPadding, top,
					getWidth() - getPaddingRight() - mDividerPadding, top
							+ mDividerHeight);
			mDivider.draw(canvas);
		}
	}
	...
	void drawVerticalDivider(Canvas canvas, int left) {
		if (mClipDivider && !IS_HONEYCOMB) {
			canvas.save();
			canvas.clipRect(left, getPaddingTop() + mDividerPadding, left
